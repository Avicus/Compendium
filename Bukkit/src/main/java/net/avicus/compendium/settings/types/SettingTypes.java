...
public class SettingTypes {
     ...
     */
    public static final NumberSettingType<Double> DOUBLE = new NumberSettingType<>(Double::parseDouble);
    /**
     ...
     */
    public static final NumberSettingType<Integer> INTEGER = new NumberSettingType<>(Integer::parseInt);
    /**
